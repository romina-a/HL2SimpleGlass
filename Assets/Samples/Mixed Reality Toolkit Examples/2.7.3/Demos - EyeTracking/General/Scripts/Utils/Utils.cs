...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos.EyeTracking
{
    ...
    public static class EyeTrackingDemoUtils
    {
        ...
        /// <summary>
        /// Returns the full name of a given GameObject in the type graph.
        /// </summary>
        ...
        /// <summary>
        /// Loads a Unity type with the given name.
        /// </summary>
        /// <param name="sceneToBeLoaded">Name of the type to be loaded.</param>
        ...
        /// <summary>
        /// Loads a Unity type with the given name after a given delay in seconds.
        /// </summary>
        /// <param name="sceneToBeLoaded">Name of the type to be loaded.</param>
        /// <param name="delayInSeconds">Delay in seconds to wait before loading the new type.</param>
