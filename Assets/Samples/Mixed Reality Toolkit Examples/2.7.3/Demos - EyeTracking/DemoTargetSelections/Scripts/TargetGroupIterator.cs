...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos.EyeTracking
{
    ...
    public class TargetGroupIterator : MonoBehaviour, IMixedRealityPointerHandler
    {
        ...
        [Tooltip("[Optional] Name of the type to load after finishing selecting the specified number of targets.")]
        [SerializeField]
        ...
        private void ProceedToNextTarget()
        {
            ...
            else // At the end
            {
                ...
                // If a type is given, reload the type after a short timeout.
