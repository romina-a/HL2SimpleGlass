...
{
    /// <summary>
    /// Demo class to show different ways of visualizing the space using type understanding.
    /// </summary>
    public class DemoSceneUnderstandingController : DemoSpatialMeshHandler, IMixedRealitySpatialAwarenessObservationHandler<SpatialAwarenessSceneObject>
    {
        ...
        protected override void Start()
        {
            ...
            if (observer == null)
            {
                Debug.LogError("Couldn't access Scene Understanding Observer! Please make sure the current build target is set to Universal Windows Platform. "
                    + "Visit https://docs.microsoft.com/windows/mixed-reality/mrtk-unity/features/spatial-awareness/type-understanding for more information.");
                return;
            }
        ...
        /// </remarks>
        /// <returns>A dictionary with the type objects of the requested type being the values and their ids being the keys.</returns>
        ...
        /// <summary>
        /// Request the observer to update the type
        /// </summary>
        ...
        /// <summary>
        /// Request the observer to save the type
        /// </summary>
        ...
        /// <summary>
        /// Request the observer to clear the observations in the type
        /// </summary>
